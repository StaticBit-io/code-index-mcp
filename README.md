...
| all-minilm | **26 MB** | 45 MB | 384 native | 91.9 s (~1.5 min) | **15.8 MB** | 58 ms | 2/7 rank 1 (drops→XRP, address parsing) + 3 more at rank 2–3 (tx hash, trust-line validation, websocket) + 1 weak (retry) + 1 miss (payment signing) | ~0.28 | *(none — no asymmetric training)* |
